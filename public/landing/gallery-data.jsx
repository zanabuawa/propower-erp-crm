// Catalogo real de proyectos de la galería ProPower
...
// flat list, intercalado por categoría para diversidad visual
const ALL_GALLERY_IMAGES = (() => {
  const out = [];
  let max = Math.max(...PROJECT_CATEGORIES.map(c => c.images.length));
  for (let i = 0; i < max; i++) {
...
Object.assign(window, { PROJECT_CATEGORIES, ALL_GALLERY_IMAGES });
