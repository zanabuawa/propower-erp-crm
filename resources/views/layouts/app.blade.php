    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: true }">
        ...
        <aside class="bg-[#1e2130] text-white flex flex-col transition-all duration-300 overflow-hidden z-20"
            ...
            <nav class="flex-1 overflow-y-auto py-2">
                ...
                <x-sidebar-item route="branches.index" icon="companies" label="Sucursales" />
            ...
            <div class="flex items-center gap-3 px-4 py-3 border-t border-white/10">
                <div
                    class="w-8 h-8 min-w-[2rem] rounded-full bg-[#2d3a5e] flex items-center justify-center text-xs font-medium text-indigo-300">
