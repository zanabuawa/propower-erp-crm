<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
        <input wire:model.live.debounce.300ms="search" type="text"
            ...
            class="sm:col-span-2 border border-gray-200 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300">
            ...
            <table class="w-full text-sm min-w-[640px]">
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50">
                        ...
                        <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 hidden md:table-cell">Usuario</th>
                        <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 hidden md:table-cell">Fecha</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($movements as $movement)
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-5 py-3">
                                ...
                                <p class="text-xs text-gray-400 md:hidden">{{ $movement->moved_at->format('d/m/Y') }}</p>
                            </td>
                            <td class="px-5 py-3">
                            ...
                            <td class="px-5 py-3 text-gray-600 hidden md:table-cell">{{ $movement->moved_at->format('d/m/Y H:i') }}</td>
                            <td class="px-5 py-3">
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-5 py-10 text-center text-gray-400 text-sm">No se encontraron movimientos.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
