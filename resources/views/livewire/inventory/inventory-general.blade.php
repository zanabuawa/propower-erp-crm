<div>
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-xl font-medium text-gray-900">Inventario general</h1>
            <p class="text-sm text-gray-400 mt-0.5">Existencias totales de todos los almacenes</p>
        </div>
        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-gray-100 bg-gray-50">
                    ...
                    <th class="text-right text-xs text-gray-500 font-medium px-4 py-3">Valor total</th>
            ...
            <tbody class="divide-y divide-gray-50">
                @forelse($products as $product)
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3 text-right text-gray-400 text-xs">{{ number_format($product->min_stock, 2) }}</td>
                        <td class="px-4 py-3 text-right text-gray-600">${{ number_format($product->purchase_price, 2) }}</td>
                        <td class="px-4 py-3 text-right text-gray-800">${{ number_format($product->sale_price, 2) }}</td>
