<div>
    <div class="flex items-center gap-3 mb-6">
        ...
        <a wire:navigate href="{{ route('works.projects.show', $project) }}"
            class="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm border border-sky-200 rounded-lg text-sky-700 hover:bg-sky-50 transition font-medium">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 21h18M5 21V9l7-4 7 4v12M9 21v-6h6v6"/></svg>
            Control de obra
        </a>
        @endcan
        @can('edit projects')
