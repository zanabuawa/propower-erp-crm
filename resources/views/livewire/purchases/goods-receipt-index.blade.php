<div>
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        ...
        <a wire:navigate href="{{ route('purchases.goods-receipts.create') }}"
            class="inline-flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-700 text-white text-sm font-medium px-4 py-2 rounded-lg transition">
            + Nueva recepción
        </a>
    </div>
            ...
            <table class="w-full text-sm min-w-[580px]">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-100">
                        ...
                        <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 hidden sm:table-cell">Referencia</th>
                        <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 hidden sm:table-cell">Productos</th>
                        <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 hidden md:table-cell">Registrado por</th>
                    ...
                    @forelse($movements as $movement)
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-5 py-3">
                                ...
                                <p class="text-xs text-gray-400 sm:hidden">{{ $movement->reference ?? '—' }}</p>
                            </td>
