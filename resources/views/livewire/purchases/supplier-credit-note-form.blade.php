<div>
    <x-page-header title="Registrar nota de crédito de proveedor" description="Devolución, ajuste de precio o corrección de factura">
        <x-slot:actions>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-5">
        ...
        <div class="xl:col-span-2 space-y-5">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                <h3 class="text-sm font-semibold text-gray-700 mb-4">Datos de la nota de crédito</h3>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        <label class="block text-xs font-medium text-gray-600 mb-1">
                            Factura de proveedor <span class="text-gray-400">(opcional)</span>
                        </label>
                        ...
                        <p class="text-xs text-indigo-600 mt-1">
                            Factura: {{ $loadedInvoice['folio'] }} — Saldo: ${{ number_format($loadedInvoice['balance'], 2) }}
                        </p>
                        @endif
                    </div>
                    ...
                    {{-- N° NC proveedor --}}
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">N° NC del proveedor</label>
                        <input wire:model="supplierCreditNoteNumber" type="text"
                               placeholder="Ej. NC-2024-005"
                               class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300">
                    </div>

                    {{-- Fecha --}}
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Fecha de emisión <span class="text-red-400">*</span></label>
                    ...
                    {{-- Motivo --}}
                    <div>
                        <label class="block text-xs font-medium text-gray-600 mb-1">Motivo <span class="text-red-400">*</span></label>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="flex items-center justify-between px-5 py-3 border-b border-gray-100">
                    <h3 class="text-sm font-semibold text-gray-700">Partidas de la nota de crédito</h3>
                    ...
                    <table class="w-full text-sm min-w-[640px]">
                        <thead>
                            <tr class="bg-gray-50 border-b border-gray-100">
                                ...
                                <th class="text-right px-4 py-2 text-xs font-semibold text-gray-500 w-24">Cantidad</th>
                            ...
                            <tr class="hover:bg-gray-50/50">
                                <td class="px-4 py-2">
                                    <input wire:model.live="items.{{ $idx }}.description"
                                           type="text" placeholder="Descripción del artículo"
                                           class="w-full border-0 bg-transparent text-sm focus:outline-none focus:ring-1 focus:ring-indigo-300 rounded px-1 py-0.5">
                                </td>
                                <td class="px-4 py-2">
        ...
        <div class="space-y-4">
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between text-gray-600">
                        <span>IVA</span><span>${{ number_format($taxAmount, 2) }}</span>
                    </div>
                    <div class="border-t border-gray-100 pt-2 flex justify-between font-bold text-gray-900 text-base">
                        <span>Total NC</span><span>${{ number_format($total, 2) }}</span>
                    </div>
                </div>
            </div>
            ...
            <button wire:click="save" wire:loading.attr="disabled"
                ...
                <span wire:loading.remove wire:target="save">Registrar nota de crédito</span>
