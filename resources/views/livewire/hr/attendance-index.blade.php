        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-slate-100 bg-slate-50/60">
                    ...
                    <th class="text-left px-4 py-3 text-xs font-semibold text-slate-500 uppercase hidden lg:table-cell">Horas</th>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50/50">
                    ...
                    <td class="px-4 py-3 hidden md:table-cell text-slate-600 font-mono">{{ $att->check_in ?? '—' }}</td>
                    <td class="px-4 py-3 hidden md:table-cell text-slate-600 font-mono">{{ $att->check_out ?? '—' }}</td>
                    <td class="px-4 py-3 hidden lg:table-cell text-slate-600">{{ $att->worked_hours ?? '—' }}</td>
                    <td class="px-4 py-3">
                ...
                @empty
                <tr><td colspan="7" class="px-4 py-10 text-center text-slate-400 text-sm">No hay registros de asistencia para los filtros seleccionados.</td></tr>
                @endforelse
            </tbody>
        </table>
