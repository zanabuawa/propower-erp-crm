            ...
            <table class="w-full text-sm min-w-[580px]">
                <thead>
                    <tr class="border-b border-gray-100 bg-gray-50">
                        ...
                        <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 hidden sm:table-cell">Moneda</th>
                        <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 hidden md:table-cell">Productos</th>
                        <th class="text-left px-5 py-3 text-xs font-medium text-gray-500 hidden sm:table-cell">Vigencia</th>
                    ...
                    @forelse($priceLists as $list)
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-5 py-3">
                                ...
                                <p class="text-xs text-gray-400 sm:hidden">{{ $list->currency }}</p>
                            </td>
