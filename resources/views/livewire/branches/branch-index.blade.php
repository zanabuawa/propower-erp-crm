        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-gray-100 bg-gray-50">
                    ...
                    <th class="text-left px-5 py-3 text-xs font-medium text-gray-500">Ciudad</th>
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse($branches as $branch)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-5 py-3 text-gray-600">{{ $branch->company?->name ?? '—' }}</td>
                        <td class="px-5 py-3 text-gray-600">{{ $branch->code ?? '—' }}</td>
                        <td class="px-5 py-3 text-gray-600">{{ $branch->city ?? '—' }}</td>
                        <td class="px-5 py-3 text-gray-600">{{ $branch->users_count }}</td>
                        <td class="px-5 py-3">
