<div>
    <x-page-header title="Flujo de caja" description="Proyección y control de entradas y salidas">
        <x-slot:actions>
            <a href="{{ route('finance.cashflow.print', request()->query()) }}" target="_blank"
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
        ...
        <div class="px-5 py-3 border-t border-gray-100">{{ $cashflows->links('vendor.pagination.tailwind') }}</div>
        @endif
    </div>
</div>
