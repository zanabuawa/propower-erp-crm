            ...
            <tbody class="divide-y divide-gray-100">
                @forelse($suppliers as $supplier)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-5 py-3 font-mono text-xs text-gray-600">{{ $supplier->rfc ?? '—' }}</td>
                        <td class="px-5 py-3 text-gray-600">{{ $supplier->primary_phone ?? '—' }}</td>
                        <td class="px-5 py-3 text-gray-600">{{ $supplier->contacts_count }}</td>
                        <td class="px-5 py-3">
