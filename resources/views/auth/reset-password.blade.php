            ...
            <div class="w-full max-w-md bg-white lg:bg-transparent p-8 lg:p-0 rounded-3xl shadow-2xl lg:shadow-none border border-white/10 lg:border-none">
                <div class="text-center lg:text-left mb-8">
                    <h2 class="text-2xl font-extrabold text-zinc-900 tracking-tight leading-none uppercase">
                        Restablecer <span class="text-red-600">Contraseña</span>
                    </h2>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
                    ...
                    {{-- Email --}}
                    <div>
                        <label for="email" class="block text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] mb-1.5 ml-1">Correo electrónico</label>
                    ...
                    {{-- Nueva contraseña --}}
                    <div>
                        <label for="password" class="block text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] mb-1.5 ml-1">Nueva contraseña</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="w-4 h-4 text-zinc-400 group-focus-within:text-red-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-[10px] font-black text-zinc-400 uppercase tracking-[0.2em] mb-1.5 ml-1">Confirmar contraseña</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="w-4 h-4 text-zinc-400 group-focus-within:text-red-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
