...
class AttendanceIndex extends Component
{
    ...
    {
        $this->reset(['editingId','employee_id','check_in','check_out','notes']);
    ...
    {
        $attendances = HrAttendance::with('employee')
        ...
        $summary = [];
        if ($this->filterDate) {
            $summary = HrAttendance::where('date', $this->filterDate)
        ...
        return view('livewire.hr.attendance-index', compact('attendances', 'employees', 'summary'));
    }
}
