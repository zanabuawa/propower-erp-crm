...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public static array $extraPermissions = [
        ...
        'tenders' => [
            'manage tender catalog' => 'Gestionar catálogo APU',
            'evaluate tenders'      => 'Evaluar licitaciones',
            'manage work permits'   => 'Gestionar permisos de trabajo',
            'manage work reports'   => 'Gestionar reportes de obra',
            'approve libranzas'     => 'Aprobar libranzas/estimaciones',
            'view tender analytics' => 'Ver analíticas de licitaciones',
        ],
        'reports' => [
